...
import static com.yuluo.eyaicodemother.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    /**
     * 覆写逻辑删除：同时写入 deleteId = id，
     * 配合 (userAccount, deleteId) 联合唯一索引，支持同名账号注销后重新注册
     */
    @Override
    public boolean removeById(Serializable id) {
        return this.mapper.logicDeleteById((Long) id) > 0;
    }
